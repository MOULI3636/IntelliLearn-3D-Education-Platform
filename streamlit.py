...
def show_correlation_matrix():
    ...
    sns.heatmap(numeric_df.corr(), annot=True, cmap='coolwarimport streamlit as st')
import pandas as pd
import numpy as np
import matplotlib.pyplot as plt
import seaborn as sns
...
def add_custom_css():
    """Adds custom CSS for theming the Streamlit app."""
    st.markdown(
        """
        <style>
        /* Global Styles */
        body, .stApp {
            background-color: hsl(170, 75%, 90%);
            color: #2C3E50;
        }
        ...
        /* Buttons */
        .stButton>button {
            background-color: hsl(170, 75%, 41%) !important;
        ...
        .stButton>button:hover {
            background-color: hsl(170, 75%, 35%) !important;
        }
        ...
        /* Expander */
        .st-expander {
            border-left: 4px solid hsl(170, 75%, 41%);
        }

        /* Metrics */
        .stMetric {
            background-color: hsl(170, 75%, 85%);
            padding: 10px;
            border-radius: 10px;
        }
        </style>
